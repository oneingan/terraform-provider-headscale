...
func (o *HeadscaleServiceExpireNodeOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/node/{nodeId}/expire][%d] headscaleServiceExpireNodeOK  %+v", 200, o.Payload)
}
...
func (o *HeadscaleServiceExpireNodeDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/node/{nodeId}/expire][%d] HeadscaleService_ExpireNode default  %+v", o._statusCode, o.Payload)
}
