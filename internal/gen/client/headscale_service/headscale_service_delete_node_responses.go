...
func (o *HeadscaleServiceDeleteNodeOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/node/{nodeId}][%d] headscaleServiceDeleteNodeOK  %+v", 200, o.Payload)
}
...
func (o *HeadscaleServiceDeleteNodeDefault) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/node/{nodeId}][%d] HeadscaleService_DeleteNode default  %+v", o._statusCode, o.Payload)
}
